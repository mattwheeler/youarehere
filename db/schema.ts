/**
 * D1 schema for the authoritative mission runtime.
 *
 * Each entry is exactly one SQL statement because Cloudflare D1 prepared
 * statements do not accept a multi-statement string.
 */
export const missionSchemaStatements = [
